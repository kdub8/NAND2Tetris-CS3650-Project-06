 ...
 * (A_COMMAND, C_COMMAND, or L_COMMAND), and extract the associated symbol or value, as well as the "dest," "comp," and "jump" components 
 * of C_COMMANDs. Additionally, it handles comments and whitespace in the input file, and it ensures the input file is closed properly when 
 * no longer needed. This class is intended to assist in parsing assembly code by providing access to various elements of assembly language 
 * instructions.
 */
